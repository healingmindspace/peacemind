...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    // Science: Why Journaling & Mood Tracking Work
    "learn.trackingTitle": "The Science of Self-Tracking",
    "learn.trackingWhat": "Tracking your mood and journaling aren't just feel-good habits — they're backed by decades of clinical research. Studies show that people who regularly monitor their emotional state experience measurable reductions in depression and anxiety symptoms. The simple act of noticing how you feel changes how your brain processes emotions.",
    "learn.trackingSigns": "What the research says:\n\n• A 2021 meta-analysis in the Journal of Medical Internet Research found that mood self-monitoring significantly reduces depressive symptoms.\n• Dr. James Pennebaker's landmark research (replicated 100+ times since 1986) shows that expressive writing for just 15-20 minutes reduces anxiety, depression, and even doctor visits.\n• A 2018 study found that positive affect journaling reduced anxiety and depressive symptoms within 12 weeks.\n• Gratitude journaling improved well-being and reduced depression in just 10 weeks (Emmons & McCullough, 2003).\n• Thought records — structured journaling combined with mood tracking — are the foundation of Cognitive Behavioral Therapy (CBT), the gold standard treatment for anxiety and depression.\n\nThe key finding: it's the awareness that heals. When you notice your patterns, you naturally start making changes. Your brain literally builds new neural pathways through repeated self-reflection.",
    "learn.trackingHelp": "You don't need to write a novel. One mood check-in takes 10 seconds. A journal entry can be one sentence. The power is in consistency, not length. Try this: log your mood every evening for one week. At the end, look at the pattern. Most people are surprised by what they discover — triggers they didn't notice, patterns they couldn't see in the moment. That awareness is the first step to change. This app encrypts everything you write, so be completely honest — it's the honesty that makes it work.",
  ...
  zh: {
    ...
    "learn.trackingTitle": "自我追踪的科学",
    "learn.trackingWhat": "追踪情绪和写日记不只是感觉好的习惯——它们有几十年的临床研究支持。研究表明，定期监测情绪状态的人，抑郁和焦虑症状会有可测量的减少。仅仅注意到自己的感受，就能改变大脑处理情绪的方式。",
    "learn.trackingSigns": "研究怎么说：\n\n• 2021年《医学互联网研究杂志》的荟萃分析发现，情绪自我监测显著减少了抑郁症状。\n• James Pennebaker博士的里程碑研究（自1986年被重复验证100多次）表明，每天15-20分钟的表达性写作可减少焦虑、抑郁，甚至减少看医生的次数。\n• 2018年的研究发现，积极情感日记在12周内减少了焦虑和抑郁症状。\n• 感恩日记在短短10周内改善了幸福感并减少了抑郁（Emmons & McCullough, 2003）。\n• 思维记录——结合情绪追踪的结构化日记——是认知行为疗法（CBT）的基础，CBT是治疗焦虑和抑郁的金标准。\n\n关键发现：是觉察在治愈。当你注意到自己的模式时，你自然会开始做出改变。你的大脑通过反复的自我反思，真的在建立新的神经通路。",
    "learn.trackingHelp": "你不需要写一本小说。一次情绪打卡只需10秒。日记可以只写一句话。力量在于坚持，不在于长度。试试这个：连续一周每晚记录你的情绪。周末回顾一下模式。大多数人会对发现感到惊讶——他们没注意到的触发因素，在当下看不到的模式。那种觉察就是改变的第一步。这个应用加密了你写的所有内容，所以请完全坦诚——正是这种坦诚让它有效。",
