...
export default function SupportChat() {
  ...
  return (
    <>
      ...
      {/* Chat panel */}
      {open && (
        <div className="fixed bottom-20 right-4 md:bottom-6 md:right-6 w-80 max-h-[28rem] bg-pm-surface border border-pm-border rounded-2xl shadow-xl flex flex-col z-50 overflow-hidden">
          {/* Header */}
